...
public class Validation extends ViewModel {
    ...
    public static boolean isNetworkImage(ImageView imageView) {
    ...
    public static boolean isNumberHiddenValid(String numberHidden) {
    ...
    public static boolean isLearningRate(String learningRate) {
    ...
    public static boolean isNumberCycleValid(String numberCycle) {
        if ((!numberCycle.matches("[0-9]+") || Integer.parseInt(numberCycle) > 100
